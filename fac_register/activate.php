...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'yourname@gmail.com'; // Replace with your Gmail email
            $mail->Password = 'your-gmail-password'; // Replace with your Gmail password or App Password
            $mail->SMTPSecure = 'tls';
            $mail->Port = 587;

            // Recipient
            $mail->setFrom('yourname@gmail.com', 'Admin'); // Replace with your Gmail email and desired sender name
